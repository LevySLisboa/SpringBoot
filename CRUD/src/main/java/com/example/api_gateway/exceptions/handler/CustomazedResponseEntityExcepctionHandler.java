...
@ControllerAdvice
@RestController
public class CustomazedResponseEntityExcepctionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<ExceptionResponse> handlenNotFoundExceptions(Exception ex, WebRequest request){
        ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(),ex.getMessage(),request.getDescription(false));
    ...
    @ExceptionHandler(InvalidJwtAutheticationlException.class)
    public final ResponseEntity<ExceptionResponse> handlenInvalidJwtAutheticationlExceptionExceptions(Exception ex, WebRequest request){
        ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(),ex.getMessage(),request.getDescription(false));
