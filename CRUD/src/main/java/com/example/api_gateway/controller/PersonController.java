...
public class PersonController {
    ...
    @Operation(summary = "Adds a new Person", description = "Adds a new person by parsing a JSON,XML or YML representation of the person", tags = {"People"},
            responses = {
                    @ApiResponse(description = "Success", responseCode = "200", content = {
                            @Content(schema = @Schema(implementation = PersonVO.class))
                    }),
    ...
    @PutMapping(
            produces = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML},
            consumes = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML})
    @Operation(summary = "Updates a new Person", description = "Updates a new person by parsing a JSON,XML or YML representation of the person", tags = {"People"},
            responses = {
    ...
    @Operation(summary = "Deletes a new Person", description = "Deletes a new Person", tags = {"People"},
            responses = {
                    @ApiResponse(description = "No Content", responseCode = "204", content = @Content),
                    @ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
                    @ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
